...
public class SelfEnablerWebViewActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_self_enabler_web_view);
       ...
       ivBack = (ImageView)toolbar.findViewById(R.id.ivSEBack);
       rlBack = (RelativeLayout)toolbar.findViewById(R.id.rlBack);
        ...
        mywebview.setWebChromeClient(new WebChromeClient() {
            public void onProgressChanged(WebView paramAnonymousWebView, int paramAnonymousInt) {
                SelfEnablerWebViewActivity.this.setTitle("Loading...");
                SelfEnablerWebViewActivity.this.setProgress(paramAnonymousInt * 100);
                if (paramAnonymousInt == 100) {
                    SelfEnablerWebViewActivity.this.setTitle("We4Coding");
                }
            }
        });
        mywebview.getSettings().setRenderPriority(WebSettings.RenderPriority.HIGH);
        mywebview.setWebViewClient(new WebViewClient());
        mywebview.loadUrl("http://selfenabler.com/");
